...
进入官网http://mirrors.ustc.edu.cn/help/centos.html
...
直接使用epel源virt-manager-1.4.0可以使用，然后重装virt-viewer即可
以下安装文件仅作参考，红字是重点！！！
# 安装 kvm 基础包
# ------------------------
yum -y install kvm
...
4.图形界面安装配置虚拟机
1.使用vnc连接登录centos7（见七远程centos7）
...
# virsh  start  vm1
四、smb服务部署
https://www.linuxidc.com/Linux/2018-01/150448.htm
1.smb服务命令
systemctl start smb
